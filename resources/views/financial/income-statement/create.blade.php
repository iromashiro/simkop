{{-- resources/views/financial/income-statement/create.blade.php --}}
@extends('layouts.app')

@section('title', 'Buat Laporan Perhitungan Hasil Usaha')

@php
$header = [
'title' => 'Buat Laporan Perhitungan Hasil Usaha',
...
['title' => 'Buat Baru', 'url' => route('financial.income-statement.create')]
];
@endphp

@section('content')
<form action="{{ route('financial.income-statement.store') }}" method="POST" id="incomeStatementForm"
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pendapatan_jasa_simpan_pinjam', 0) }}"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pendapatan_administrasi', 0) }}" x-model="data.pendapatan_administrasi"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        id="pendapatan_provisi" name="pendapatan_provisi" value="{{ old('pendapatan_provisi', 0) }}"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pendapatan_operasional_lainnya', 0) }}"
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pendapatan_bunga_bank', 0) }}" x-model="data.pendapatan_bunga_bank"
                        @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pendapatan_non_operasional_lainnya', 0) }}"
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('beban_bunga_simpanan', 0) }}" x-model="data.beban_bunga_simpanan"
                        @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('beban_administrasi_umum', 0) }}" x-model="data.beban_administrasi_umum"
                        @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        id="beban_personalia" name="beban_personalia" value="{{ old('beban_personalia', 0) }}"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        id="beban_penyusutan" name="beban_penyusutan" value="{{ old('beban_penyusutan', 0) }}"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('beban_operasional_lainnya', 0) }}" x-model="data.beban_operasional_lainnya"
                        @input="calculateTotals()">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        id="beban_bunga_bank" name="beban_bunga_bank" value="{{ old('beban_bunga_bank', 0) }}"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('beban_non_operasional_lainnya', 0) }}"
...
<script>
    ...
    return {
        data: {
            // Pendapatan Operasional
            pendapatan_jasa_simpan_pinjam: 0,
            pendapatan_administrasi: 0,
            pendapatan_provisi: 0,
            pendapatan_operasional_lainnya: 0,
            total_pendapatan_operasional: 0,

            // Pendapatan Non-Operasional
            pendapatan_bunga_bank: 0,
            pendapatan_non_operasional_lainnya: 0,
            total_pendapatan_non_operasional: 0,
            total_pendapatan: 0,

            // Beban Operasional
            beban_bunga_simpanan: 0,
            beban_administrasi_umum: 0,
            beban_personalia: 0,
            beban_penyusutan: 0,
            beban_operasional_lainnya: 0,
            total_beban_operasional: 0,

            // Beban Non-Operasional
            beban_bunga_bank: 0,
            beban_non_operasional_lainnya: 0,
            total_beban_non_operasional: 0,
            total_beban: 0
        },
...
function autoSave() {
    ...
    fetch('/api/financial/auto-save/income-statement/' + formData.get('reporting_year'), {
        method: 'POST',
        headers: {
