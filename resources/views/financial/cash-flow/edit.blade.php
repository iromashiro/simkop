{{-- resources/views/financial/cash-flow/edit.blade.php --}}
@extends('layouts.app')

@section('title', 'Edit Laporan Arus Kas')

@php
$header = [
'title' => 'Edit Laporan Arus Kas Tahun ' . $report->reporting_year,
'subtitle' => 'Perbarui laporan pergerakan kas koperasi'
];
...
['title' => 'Edit', 'url' => route('financial.cash-flow.edit', $report)]
];
@endphp

@section('content')
<form action="{{ route('financial.cash-flow.update', $report) }}" method="POST" id="cashFlowForm"
    x-data="cashFlowForm()">
    @csrf
    @method('PUT')
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('penerimaan_dari_anggota', $activities['operating']['inflow']['penerimaan_dari_anggota'] ?? 0) }}"
                        x-model="data.penerimaan_dari_anggota" @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('penerimaan_bunga_pinjaman', $activities['operating']['inflow']['penerimaan_bunga_pinjaman'] ?? 0) }}"
                        x-model="data.penerimaan_bunga_pinjaman" @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('penerimaan_jasa_lainnya', $activities['operating']['inflow']['penerimaan_jasa_lainnya'] ?? 0) }}"
                        x-model="data.penerimaan_jasa_lainnya" @input="calculateTotals()">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pembayaran_bunga_simpanan', $activities['operating']['outflow']['pembayaran_bunga_simpanan'] ?? 0) }}"
                        x-model="data.pembayaran_bunga_simpanan" @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pembayaran_beban_operasional', $activities['operating']['outflow']['pembayaran_beban_operasional'] ?? 0) }}"
                        x-model="data.pembayaran_beban_operasional" @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pembayaran_gaji_karyawan', $activities['operating']['outflow']['pembayaran_gaji_karyawan'] ?? 0) }}"
                        x-model="data.pembayaran_gaji_karyawan" @input="calculateTotals()">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('penjualan_aset_tetap', $activities['investing']['inflow']['penjualan_aset_tetap'] ?? 0) }}"
                        x-model="data.penjualan_aset_tetap" @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        id="penerimaan_dividen" name="penerimaan_dividen"
                        value="{{ old('penerimaan_dividen', $activities['investing']['inflow']['penerimaan_dividen'] ?? 0) }}"
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pembelian_aset_tetap', $activities['investing']['outflow']['pembelian_aset_tetap'] ?? 0) }}"
                        x-model="data.pembelian_aset_tetap" @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('investasi_jangka_panjang', $activities['investing']['outflow']['investasi_jangka_panjang'] ?? 0) }}"
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('penerimaan_simpanan_anggota', $activities['financing']['inflow']['penerimaan_simpanan_anggota'] ?? 0) }}"
                        x-model="data.penerimaan_simpanan_anggota" @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('penerimaan_pinjaman_bank', $activities['financing']['inflow']['penerimaan_pinjaman_bank'] ?? 0) }}"
                        x-model="data.penerimaan_pinjaman_bank" @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        id="penambahan_modal" name="penambahan_modal"
                        value="{{ old('penambahan_modal', $activities['financing']['inflow']['penambahan_modal'] ?? 0) }}"
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pembayaran_simpanan_anggota', $activities['financing']['outflow']['pembayaran_simpanan_anggota'] ?? 0) }}"
                        x-model="data.pembayaran_simpanan_anggota" @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('pembayaran_pinjaman_bank', $activities['financing']['outflow']['pembayaran_pinjaman_bank'] ?? 0) }}"
                        x-model="data.pembayaran_pinjaman_bank" @input="calculateTotals()">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control money-input @error('pembayaran_shu') is-invalid @enderror"
                        id="pembayaran_shu" name="pembayaran_shu"
                        value="{{ old('pembayaran_shu', $activities['financing']['outflow']['pembayaran_shu'] ?? 0) }}"
...
<script>
    ...
    return {
        data: {
            ...
            penerimaan_dari_anggota: {{ $activities['operating']['inflow']['penerimaan_dari_anggota'] ?? 0 }},
            penerimaan_bunga_pinjaman: {{ $activities['operating']['inflow']['penerimaan_bunga_pinjaman'] ?? 0 }},
            penerimaan_jasa_lainnya: {{ $activities['operating']['inflow']['penerimaan_jasa_lainnya'] ?? 0 }},
            total_kas_masuk_operasional: {{ $totals['total_kas_masuk_operasional'] ?? 0 }},

            pembayaran_bunga_simpanan: {{ $activities['operating']['outflow']['pembayaran_bunga_simpanan'] ?? 0 }},
            pembayaran_beban_operasional: {{ $activities['operating']['outflow']['pembayaran_beban_operasional'] ?? 0 }},
            pembayaran_gaji_karyawan: {{ $activities['operating']['outflow']['pembayaran_gaji_karyawan'] ?? 0 }},
            total_kas_keluar_operasional: {{ $totals['total_kas_keluar_operasional'] ?? 0 }},
            kas_bersih_operasional: {{ $totals['kas_bersih_operasional'] ?? 0 }},

            penjualan_aset_tetap: {{ $activities['investing']['inflow']['penjualan_aset_tetap'] ?? 0 }},
            penerimaan_dividen: {{ $activities['investing']['inflow']['penerimaan_dividen'] ?? 0 }},
            total_kas_masuk_investasi: {{ $totals['total_kas_masuk_investasi'] ?? 0 }},

            pembelian_aset_tetap: {{ $activities['investing']['outflow']['pembelian_aset_tetap'] ?? 0 }},
            investasi_jangka_panjang: {{ $activities['investing']['outflow']['investasi_jangka_panjang'] ?? 0 }},
            total_kas_keluar_investasi: {{ $totals['total_kas_keluar_investasi'] ?? 0 }},
            kas_bersih_investasi: {{ $totals['kas_bersih_investasi'] ?? 0 }},

            penerimaan_simpanan_anggota: {{ $activities['financing']['inflow']['penerimaan_simpanan_anggota'] ?? 0 }},
            penerimaan_pinjaman_bank: {{ $activities['financing']['inflow']['penerimaan_pinjaman_bank'] ?? 0 }},
            penambahan_modal: {{ $activities['financing']['inflow']['penambahan_modal'] ?? 0 }},
            total_kas_masuk_pendanaan: {{ $totals['total_kas_masuk_pendanaan'] ?? 0 }},

            pembayaran_simpanan_anggota: {{ $activities['financing']['outflow']['pembayaran_simpanan_anggota'] ?? 0 }},
            pembayaran_pinjaman_bank: {{ $activities['financing']['outflow']['pembayaran_pinjaman_bank'] ?? 0 }},
            pembayaran_shu: {{ $activities['financing']['outflow']['pembayaran_shu'] ?? 0 }},
            total_kas_keluar_pendanaan: {{ $totals['total_kas_keluar_pendanaan'] ?? 0 }},
            kas_bersih_pendanaan: {{ $totals['kas_bersih_pendanaan'] ?? 0 }}
        },
...
function autoSave() {
    ...
    fetch('/api/financial/auto-save/cash-flow/{{ $report->id }}', {
        method: 'POST',
        headers: {
